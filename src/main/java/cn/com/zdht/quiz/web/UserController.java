...
public class UserController {
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "获取用户列表成功"),
            @ApiResponse(code = 404, message = "用户列表为空")})
    @ApiOperation(value = "获取列表",
            tags = "用户",
            response = DosserReturnBody.class,
            notes = "获取数据库中的用户列表。")
    ...
    @ApiOperation(value = "新建",
            tags = "用户",
            response = DosserReturnBody.class,
            notes = "若新建成功，响应200：“创建用户'{username}'成功”/若已有同名用户，则相应400：“创建失败，已有同名用户'{username}'")
    @ApiResponses(value = {@ApiResponse(code = 201, message = "新建用户成功"),
            @ApiResponse(code = 400, message = "新建用户失败，已存在该用户")})
    ...
    @ApiOperation(value = "删除",
            tags = "用户",
            response = DosserReturnBody.class,
            notes = "若删除成功，响应200：“删除用户'{username}'成功”/若不存在该用户名，响应404：“删除用户失败，不存在用户'{username}'")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "删除用户成功"),
            @ApiResponse(code = 404, message = "删除用户失败，不存在该用户")})
    ...
    @ApiOperation(value = "更新",
            tags = "用户",
            response = DosserReturnBody.class,
            notes = "若更新成功，响应200：“更新用户'{username}'成功”/若不存在该用户名，响应404：“更新失败，不存在用户'{username}/若目的用户名已经存在，响应403：更新失败，已有同名用户'{username}'")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "更新用户成功"),
            @ApiResponse(code = 404, message = "更新失败，不存在该用户"),
            @ApiResponse(code = 403, message = "更新失败，已有同名用户")})
    ...
    @ApiOperation(value = "获取",
            tags = "用户",
            response = DosserReturnBody.class,
            notes = "若存在用户，响应200：获取用户成功/若不存在用户，响应404：“不存在用户'{username}'")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "获取用户成功"),
            @ApiResponse(code = 404, message = "获取用户失败，不存在用户")})
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "查询用户成功"),
            @ApiResponse(code = 404, message = "没有匹配的用户")})
